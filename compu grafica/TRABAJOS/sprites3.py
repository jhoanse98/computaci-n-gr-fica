...
if __name__=='__main__':
    ...
    #hacer un juego en el cual el jugador se mueva con el mouse y dos clases de
    #personajes (blanco y rojo) cuando el enemigo choque con un personaje rojo
    #quita vida
    #si toca los blancos gana puntos
